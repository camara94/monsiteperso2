...
import { Favorite, FavParcours } from '../shared/favorite';
...
export class FavoriteService {
  ...
  getFavorites(): Observable<FavParcours[]> {
    if (this.userId) {
      return this.afs.collection<FavParcours>('favorites', ref => ref.where('user', '==', this.userId)).valueChanges();
    } else {
